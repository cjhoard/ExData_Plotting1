...
png(filename="plot4.png",width = 480, height = 480, units = "px", pointsize = 12,type="windows")
par(mfrow=c(2,2))
...
with(powerdat, lines(datetime,Sub_metering_2,ylab='Energy sub metering',xlab='',col="red"))
